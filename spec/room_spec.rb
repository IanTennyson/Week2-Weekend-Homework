...
#   assert_equal(6, @door_queue1.length_of_door_queue)
#   assert_equal(5, @room1.num_of_guests_in_room)
# end
...
# #currently not working need to figure out how to delete the items in the door array while still leaving the 6th person in the door queue
#   assert_equal(1, @door_queue1.length_of_door_queue)
#   assert_equal(1, @room2.num_of_guests_in_room)
# end

def test_message_that_guest_has_been_returned_to_the_door
  assert_equal("The Gangsta Rap room is full, Ian has been returned to the Pleb Queue.", @room2.add_guest_to_room)
end
